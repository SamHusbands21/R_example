...
write.csv(sdg, "C:\\Users\\Sam\\Documents\\Masters_Modules\\Applied Statistics\\CW2\\sdg.csv", row.names = FALSE)
...
#reading the data and converting to factors
coffee_production <- read_csv("coffee.csv")
